...
public class PaymentAndOrderCancelTest extends TestContainersConfiguration {
    ...
    @Test
    void checkProxy() {
        System.out.println("Proxy orderFacadeService? " + AopUtils.isAopProxy(orderFacadeService));
